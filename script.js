document.addEventListener('DOMContentLoaded', function() {
    ...
    const noteText = "Hola de nuevo dama  de hermoso nombre, disculpa si mi espíritu  aún llora, mis recuerdos gritan y mis sentimeintos laten en busca de que los tuyos lo hagan una vez más en un tiempo remoto, miro hacia delante, pero choco como un mosquito en una raqueta, ya que lo más me duele es saber que no hay otra vida en dónde pueda soñar con tomar con suavidad tu mano, me hubiera gustado ir a México  a disfrutar de la compañía del otro, me hubiera gustado que tengamos el mismo color de cabello, me hubiera gustado que por medio de tu arte encantaras mis uñas, me hubiera gustado una niña con tus lindos ojos, tantos deseos fugaces encontrados en polvo, se que mi corazón  te extrañará toda la vida por lo puro que fue lo que tuvimos, esto no es un regalo es la agonía de mi alma que no significa que esté mal, solo estoy bien a mi manera, gracias por ser esa flor  de distinto color entre todas las de un prado, gracias por dejarme conocer tu personalidad  de oro, gracias alegrar mis días con tus sonrisas o tu risa, gracias por arriesgarte a intentar arreglar lo dañado, gracias por darme experiencias tan únicas que aunque nos separe la distancia te sentía como mi hogar, tal vez máximo mis problemas, pero así es mi sentir no puedo esconderlo, gracias por ser mi esperanza  Kenia.";
    ...
    function startTypewriter() {
      ...
      function appendWord() {
        if (index < words.length) {
          ...
          // Si se produce desbordamiento de la página, creamos una nueva
